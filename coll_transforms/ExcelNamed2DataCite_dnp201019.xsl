...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Transforms Excel Named XML into DataCite XML, JMU Scholarly Commons dnp201019
    Created 2018/07/20 by Rebecca B. French, Metadata Analyst Librarian at James Madison University
        ...
        <xsl:for-each select="table/row">
            <xsl:if test="doi=''">
                ...
                <xsl:variable name="itemID">
                    <xsl:analyze-string select="calc_url" regex="http://commons.lib.jmu.edu/dnp201019/">
                ...
                <xsl:result-document method="xml" href="file:///N:/UserA-F/frenchrb/Programming/JMU_DOIs/DataCite_metadata/etd_{$setName}_{$itemID}.xml">
    ...
    <xsl:template name="row" match="row">
        ...
        <resource xmlns="http://datacite.org/schema/kernel-4"
            ...
            <xsl:element name="identifier">
                ...
                <xsl:text>10.25885/etd/</xsl:text>
                <xsl:value-of select="issue"/>
                <xsl:text>/</xsl:text>
                <!--<xsl:value-of select="substring(publication_date, 1, 4)"/>
                <xsl:text>/</xsl:text>-->
            ...
            <xsl:element name="descriptions">
                ...
                <xsl:element name="description">
                    ...
                    <xsl:text>. </xsl:text>
                    <xsl:value-of select="calc_url"/> <!-- QUESTION or use doi here? -->
                </xsl:element>
            </xsl:element>
        </resource>   
